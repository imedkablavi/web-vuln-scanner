...
_BUILTIN_CHECKS = {
    ...
    "csp_posture": {
        ...
        "cwe": [],
        "wstg": [],
        "summary": "CSP enforcement and risky script-source posture analysis",
        "source": "passive-web",
    },
    "stack_trace_disclosure": {
        ...
        "cwe": ["CWE-209"],
        "wstg": [],
        "summary": "High-confidence multi-runtime stack trace disclosure detection",
        "source": "passive-web",
    },
    "technology_fingerprint": {
        "maturity": "stable",
        "activity": "passive-inventory",
        "cwe": [],
        "wstg": [],
        "summary": "Conservative technology inventory from headers, cookie names, and HTML markers",
        "source": "passive-web",
    },
    "tls_certificate_validation": {
        "maturity": "stable",
        "activity": "external-passive",
        "cwe": [],
        "wstg": [],
        "summary": "TLS certificate validation and expiry posture",
        "source": "dns-tls",
    },
    "jwt_posture": {
        "maturity": "stable",
